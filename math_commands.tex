...
\newcommand{\PLS}{\operatorname{PLS}}
...
\newcommand{\LCCA}{\mathcal{L}_\text{CCA}}
\newcommand{\LPLS}{\mathcal{L}_\text{PLS}}
\newcommand{\LRayleigh}{\mathcal{L}_\text{Rayleigh}}
\newcommand{\LDCCA}{\mathcal{L}_\text{DMCCA}}
\newcommand{\LDMCCA}{\mathcal{L}_\text{DMCCA}}
\newcommand{\LNOI}{\mathcal{L}_\text{NOI}}
\newcommand{\LCCASSL}{\mathcal{L}_\text{CCA-SSL}}
