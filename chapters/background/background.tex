...
We will refer to $\Corr(X\sps{i}_j, Z_k)$ as the \textit{\gls{loadings}} of $X\sps{i}_j$ on $Z_k$.
...
\begin{align}
     & \alpha_{\text{opt}}=\underset{\alpha_{\text{opt}}}{\mathrm{argmax}}\{ \alpha_1^{\top}K\spsT{1}K\sps{2}\alpha_2  \} \\
     & \text{subject to:} \notag                                                                                            \\
     & \alpha_1^{\top}K\spsT{1}K\sps{1}\alpha_1=1 \notag                                                                  \\
     & \alpha_2^{\top}K\spsT{2}K\sps{2}\alpha_2=1 \notag
\end{align}
