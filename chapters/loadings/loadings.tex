...
GFA can thus be seen as a generalization of Probabilistic PCA, where the noise covariance matrix is diagonal and the latent variable is shared across multiple views.
