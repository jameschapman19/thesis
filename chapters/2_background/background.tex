...
Additionally, because KCCA is non-parametric, evaluating it on out-of-sample data necessitates access to all training data at test time, posing challenges for efficiency and scalability.
