...
\section{Background: Unifying Generative Perspectives on \acrshort{cca}}
...
The process was first described by Chen~\citep{chen2013sparse} and further explained by~\citep{suo2017sparse} and has been the basis behind findings in \citet{helmer2020stability,Matkovi}.
...
\section{A Mathematical Argument for the use of Loadings not Weights for Interpretability}\label{sec:an-argument-for-the-use-of-loadings}
...
In this chapter, we use simulated data to illustrate properties of CCA models and then revisit the results of chapter~\ref{chap:frals} to demonstrate the relationship between \gls{weights} and \gls{loadings} in real-world datasets.

\subsection{Simulated Data}

We used 6 simulated datasets, generated using the methods described in section~\ref{subsec:generative-perspectives}.
